...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = '/Users/marianagaspar/Documents/2022.2/SIN110/atividade3/grafo/Instancias/' + instancia + '.txt'
...
def salvaResultado(resultado):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('/Users/marianagaspar/Documents/2022.2/SIN110/atividade3/grafo/Resultados/resultado.txt', 'a+')
